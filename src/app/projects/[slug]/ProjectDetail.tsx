          ...
          <div className="flex flex-col gap-3.5">
            {(
              ...
              <div key={label} className="grid gap-3" style={{ gridTemplateColumns: '56px 1fr' }}>
                <span
                  className="text-xs text-right pt-0.5"
                  style={{ color }}
                >
                  {label}
                </span>
...
export default function ProjectDetail({ project }: { project: Project }) {
  const sorted = [...project.troubleCards].sort((a, b) => a.importance - b.importance)
    ...
    >
      ...
      >
        <div className="max-w-4xl mx-auto px-6 py-8">
          {/* 브레드크럼 */}
          <div className="flex items-center gap-1.5 mb-5" style={{ fontSize: 11, color: 'var(--text-muted)' }}>
            <Link
              href="/#projects"
